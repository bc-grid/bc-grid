import { dateEditor, numberEditor, textEditor } from "@bc-grid/editors"
import {
  type BcCellEditor,
  BcEditGrid,
  type BcGridColumn,
  ...
  const columns = useMemo<readonly BcGridColumn<CustomerRow>[]>(
    () => [
      ...
      },
      {
        ...
        // realistic ERP constraint that an invoice can't be dated in the
        // future and must be within the last decade.
        editable: editorFrameworkEnabled(),
        ...(editorFrameworkEnabled()
