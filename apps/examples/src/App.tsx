 ...
 * dropped against the curated `customerGridGroupableColumns` set so
...
function groupsExpandedByDefaultEnabled(): boolean {
  ...
  // is immediately readable; otherwise leave collapsed. `?groupBy=…
  // &groupsCollapsed=1` opts back into the collapsed default.
