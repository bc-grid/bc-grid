...
- `[in-flight: worker5]` **motion-polish-no-scale-v030** — v0.3 follow-up to remove text-scaling / row-morph motion from expand, collapse, detail, row update, and flash transitions; document the no-scale motion rule. **Effort**: S.
