...
- `[in-flight: worker5]` **master-detail-docs-v040** — v0.4 docs/examples polish for master/detail async child content: generic recipe with stable `detailPanelHeight`, loading/empty/error states, nested grid/table content, and executable helper tests. **Effort**: S.
