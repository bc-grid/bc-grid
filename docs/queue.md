...
- `[done: x3 #42]` **q1-vertical-slice-demo** — rebuild ONE bc-next screen (e.g., AR Customers list) entirely on bc-grid. Real data, real perf, real a11y. Dependencies q1-sort (#27), q1-keyboard-focus (#28), q1-pinned-cols (#33) all merged. **Branch**: `agent/x3/q1-vertical-slice-demo`. **Effort**: 3-5 days. **This is the Q1 "is the architecture sound?" gate.**
