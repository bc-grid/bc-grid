...
- `[in-flight: worker3]` **editor-keyboard-contract-v040** — focused React/editor controller tests for 0.4 keyboard lifecycle: F2, printable seed, Enter / Shift+Enter, Tab / Shift+Tab, Escape cancel, pending async commit, and validation rejection. Branch: `agent/worker3/editor-keyboard-contract-v040`. **Effort**: S.
