...
- `[review: worker3 #157]` **context-menu-impl** — lightweight grid context menu; right-click + long-press (500ms coarse pointer) + Shift+F10. Minimal copy/clear built-ins + custom factory function. **Effort**: M.
