...
- `[in-flight: worker5]` **editor-error-surface-polish-v040** — v0.4 editor state polish: consistent pending/error/disabled hooks and tokenized CSS for built-in editor surfaces plus the default editor portal fallback. **Branch**: `agent/worker5/editor-error-surface-polish-v040`. **Effort**: S.
