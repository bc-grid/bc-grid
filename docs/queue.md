...
- `[review: worker3 #264]` **rich-editing-roadmap-v040** — post-0.4 blueprint for feature-rich in-grid editing: editor catalog, validation, async save states, server edit integration, controlled/uncontrolled API boundaries, and 0.4 / 0.5 / later phasing. **Branch**: `agent/worker3/rich-editing-roadmap-v040`. **Effort**: XS.
