...
- `[review: worker5 #184 depends on #172/#179]` **tool-panel-polish** — Wire the built-in columns / filters / pivot panels into the examples grid and give the columns panel real groupable demo fields. **Effort**: S.
