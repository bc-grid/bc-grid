...
- `[in-flight: worker1]` **range-tsv-paste-parser-v040** — internal range TSV paste parser/planner helpers: spreadsheet quoted-cell handling plus anchor-to-visible-row/column planning with skipped/out-of-bounds metadata. **Branch**: `agent/worker1/range-tsv-paste-parser-v040`. **Effort**: XS.
