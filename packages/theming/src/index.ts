...
export const bcGridThemeVars = {
  ...
  accent: "--bc-grid-accent",
  accentFg: "--bc-grid-accent-fg",
  accentSoft: "--bc-grid-accent-soft",
  dirty: "--bc-grid-dirty",
  searchMatchBg: "--bc-grid-search-match-bg",
  searchMatchFg: "--bc-grid-search-match-fg",
  contextMenuBg: "--bc-grid-context-menu-bg",
  contextMenuFg: "--bc-grid-context-menu-fg",
  contextMenuBorder: "--bc-grid-context-menu-border",
    ...
    extend: {
      colors: {
        "bc-grid": {
          ...
          accent: "var(--bc-grid-accent)",
          "accent-fg": "var(--bc-grid-accent-fg)",
          "accent-soft": "var(--bc-grid-accent-soft)",
          dirty: "var(--bc-grid-dirty)",
          "search-match": "var(--bc-grid-search-match-bg)",
          "search-match-fg": "var(--bc-grid-search-match-fg)",
          "context-menu": "var(--bc-grid-context-menu-bg)",
          "context-menu-fg": "var(--bc-grid-context-menu-fg)",
          "context-menu-border": "var(--bc-grid-context-menu-border)",
        },
      },
      borderRadius: {
