...
describe("FilterPopup — text filter operators surface", () => {
  test("popup variant renders the advanced operator + toggle controls", () => {
    // Inline text filters are deliberately compact; popup/panel
    // surfaces own the full operator UI (select + value input +
